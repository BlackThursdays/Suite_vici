...
{if !$fields.phone_work.hidden}
{counter name="panelFieldCount"}
<span id="phone_work" class="sugar_field"><span>{$fields.phone_work.value}</span>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.phones_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_PHONES' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{sugar_translate label='LBL_DETAILVIEW_PANEL1' module='Leads'}
<script>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.rnn_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_RNN' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.rnn_c.value) <= 0}
{assign var="value" value=$fields.rnn_c.default_value }
{else}
{assign var="value" value=$fields.rnn_c.value }
{/if} 
<span class="sugar_field" id="{$fields.rnn_c.name}">{$fields.rnn_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.inn_c.hidden}
...
{if strlen($fields.inn_c.value) <= 0}
{assign var="value" value=$fields.inn_c.default_value }
{else}
{assign var="value" value=$fields.inn_c.value }
{/if} 
<span class="sugar_field" id="{$fields.inn_c.name}">{$fields.inn_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.no_code_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_NO_CODE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.no_code_c.value) <= 0}
{assign var="value" value=$fields.no_code_c.default_value }
{else}
{assign var="value" value=$fields.no_code_c.value }
{/if} 
<span class="sugar_field" id="{$fields.no_code_c.name}">{$fields.no_code_c.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.oked_code_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_OKED_CODE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.oked_code_c.value) <= 0}
{assign var="value" value=$fields.oked_code_c.default_value }
{else}
{assign var="value" value=$fields.oked_code_c.value }
{/if} 
<span class="sugar_field" id="{$fields.oked_code_c.name}">{$fields.oked_code_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.register_date_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_REGISTER_DATE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.register_date_c.value) <= 0}
{assign var="value" value=$fields.register_date_c.default_value }
{else}
{assign var="value" value=$fields.register_date_c.value }
{/if}
<span class="sugar_field" id="{$fields.register_date_c.name}">{$value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.oked_name_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_OKED_NAME' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.oked_name_c.value) <= 0}
{assign var="value" value=$fields.oked_name_c.default_value }
{else}
{assign var="value" value=$fields.oked_name_c.value }
{/if} 
<span class="sugar_field" id="{$fields.oked_name_c.name}">{$fields.oked_name_c.value}</span>
{/if}
</td>
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CATEGORY' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if is_string($fields.category_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.category_c.name}" value="{ $fields.category_c.options }">
{ $fields.category_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.category_c.name}" value="{ $fields.category_c.value }">
{ $fields.category_c.options[$fields.category_c.value]}
{/if}
{/if}
</td>
{counter name="fieldsUsed"}
