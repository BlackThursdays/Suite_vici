<?php 
 $GLOBALS["dictionary"]["Call"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '',
      'labelValue' => 'Тематика звонка',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'more_theme_c',
      'vname' => 'LBL_MORE_THEME',
      'type' => 'dynamicenum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'more_theme_list',
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => 'theme_c',
      'id' => 'Callsmore_theme_c',
      'custom_module' => 'Calls',
    ),
    'result_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'Результат',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'result_c',
      'vname' => 'LBL_RESULT',
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Callsvici_call_group_c',
      'custom_module' => 'Calls',
    ),
    'vici_call_record_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Запись разговора',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'vici_call_record_c',
      'vname' => 'LBL_VICI_CALL_RECORD',
      'type' => 'url',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Callsvici_channel_c',
      'custom_module' => 'Calls',
    ),
    'vici_duration_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Продолжительность',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'vici_duration_c',
      'vname' => 'LBL_VICI_DURATION',
      'type' => 'int',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'Callsvici_duration_c',
      'custom_module' => 'Calls',
    ),
    'vici_fronter_phone_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Поступил на номер',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'vici_fronter_phone_c',
      'vname' => 'LBL_VICI_FRONTER_PHONE',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Callsvici_fronter_phone_c',
      'custom_module' => 'Calls',
    ),
    'vici_phone_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Контактный телефон',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'vici_phone_c',
      'vname' => 'LBL_VICI_PHONE',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
