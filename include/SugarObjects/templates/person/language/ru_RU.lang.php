...
$mod_strings = array(
    ...
    //GDPR labels PR 5733
    'LBL_LAWFUL_BASIS' => 'Законное основание', //GDPR - valid legal basis in order to process personal data.
    'LBL_DATE_REVIEWED' => 'Обзор Дат Законного Основания', //GDPR
    'LBL_LAWFUL_BASIS_SOURCE' => 'Источник Законной Основы', //GDPR
    //End GDPR labels
);
